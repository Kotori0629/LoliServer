...
public class FoxServerLauncher {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        System.setProperty("ignoreList", "bootstraplauncher-1.1.2.jar,securejarhandler-2.1.4.jar,asm-commons-9.6.jar,asm-util-9.6.jar,asm-analysis-9.6.jar,asm-tree-9.6.jar,asm-9.6.jar,JarJarFileSystems-0.3.16.jar");
        System.setProperty("libraryDirectory", "libraries");
        System.setProperty("legacyClassPath", String.join(Utils.isWindows() ? ";" : ":", DataManager.getLibrariesMap().entrySet().stream().map(entry -> entry.getValue().getAbsolutePath() + File.separator + entry.getKey()).toArray(String[]::new)));
