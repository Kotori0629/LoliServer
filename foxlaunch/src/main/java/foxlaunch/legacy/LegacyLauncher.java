...
public class LegacyLauncher {
    ...
    public static void loadJars() throws Exception {
        JVMHack.addModuleDynamic("libraries/org/ow2/asm/asm/9.6/asm-9.6.jar");
        JVMHack.addModuleDynamic("libraries/org/ow2/asm/asm-tree/9.6/asm-tree-9.6.jar");
        JVMHack.addModuleDynamic("libraries/org/ow2/asm/asm-analysis/9.6/asm-analysis-9.6.jar");
        JVMHack.addModuleDynamic("libraries/org/ow2/asm/asm-util/9.6/asm-util-9.6.jar");
        JVMHack.addModuleDynamic("libraries/org/ow2/asm/asm-commons/9.6/asm-commons-9.6.jar");
        JVMHack.addModuleDynamic("libraries/cpw/mods/securejarhandler/2.1.4/securejarhandler-2.1.4.jar");
        JVMHack.addModuleDynamic("libraries/cpw/mods/bootstraplauncher/1.1.2/bootstraplauncher-1.1.2.jar");
        JVMHack.addModuleDynamic("libraries/net/minecraftforge/JarJarFileSystems/0.3.16/JarJarFileSystems-0.3.16.jar");
