...
import moe.kotori.server.remapper.LoliServerRemapper;
import moe.kotori.server.remapper.RemapperClassLoader;
 ...
 */
final class PluginClassLoader extends URLClassLoader implements RemapperClassLoader {
