...
import moe.kotori.server.utils.EnumHelper;
    ...
    public static Material addMaterial(String materialName, int id, boolean isBlock, String modName) {
        ...
        if (isBlock) {
            ...
            if (material != null){
                ...
                material = (Material) EnumHelper.addEnum(Material.class, materialName, new Class[]{Integer.TYPE, Boolean.TYPE, String.class}, new Object[]{id, true, modName});
            }
            BY_NAME.put(materialName, material);
            return material;
        } else { // Forge Items
            Material material = (Material) EnumHelper.addEnum(Material.class, materialName, new Class[]{Integer.TYPE, Boolean.TYPE, String.class}, new Object[]{id, false, modName});
            BY_NAME.put(materialName, material);
            return material;
        }
    }
