...
public class LoliServerServerListPingEvent extends org.bukkit.event.server.ServerListPingEvent {

    private final Object[] players;
    public CraftIconCache icon;

    public LoliServerServerListPingEvent(Connection connection, MinecraftServer server) {
    ...
    public void setServerIcon(org.bukkit.util.CachedServerIcon icon) {
        if (!(icon instanceof CraftIconCache)) {
            throw new IllegalArgumentException(icon + " was not created by " + org.bukkit.craftbukkit.v1_19_R1.CraftServer.class);
        }
