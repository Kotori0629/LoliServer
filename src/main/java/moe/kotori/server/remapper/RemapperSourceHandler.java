...
public class RemapperSourceHandler extends URLStreamHandler {
    ...
    private static class RemapSourceConnection extends URLConnection {
        ...
        public void connect() throws IOException {
            ...
            this.array = LoliServerRemapper.getResourceMapper().remapClassFile(bytes, GlobalClassRepo.INSTANCE);
        }
    ...
    public static void register() {
        try {
            ...
            handlers.put("remap", new RemapperSourceHandler());
        } catch (Throwable e) {
